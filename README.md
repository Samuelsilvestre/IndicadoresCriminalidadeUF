...
Este projeto foi desenvolvido utilizando um conjunto de ferramentas e bibliotecas voltadas para análise de dados, visualização e construção de relatórios interativos:

- **Python** – Linguagem base para processamento e análise dos dados.  
- **Jupyter Notebook** – Ambiente interativo para exploração, testes e desenvolvimento das análises.  
- **Pandas** – Biblioteca para manipulação, transformação e limpeza de dados.  
- **Matplotlib** – Biblioteca de visualização utilizada para gráficos básicos e personalizáveis.  
- **Seaborn** – Extensão do Matplotlib focada em visualizações estatísticas mais elaboradas.  
- **Power BI** – Ferramenta utilizada para construção dos painéis interativos e dashboards finais.
...
<img src="./fig/homicidio_uf.png" width="800">

---

### **Homicídios Femininos por Estado (2015–2016)**  
<img src="./fig/homicidio_uf_feminino.png" width="600">

---

### **Total de Vítimas de Homicídio Doloso por Mês (Ordenado)**  
<img src="./fig/homicidios_por_mes_.png" width="800">

---

### **Percentual de Vítimas de Homicídio por Gênero**  
<img src="./fig/pct_homicidio_genero.png" width="500">

---

### **Percentual de Vítimas Registradas por Gênero (Distribuição Geral)**  
<img src="./fig/pct_vitima_genero.png" width="500">
